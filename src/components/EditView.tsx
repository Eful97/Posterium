              ...
              <div className="flex flex-col items-center">
                ...
                {p.previewPoster && p.selected && (
                  <div className="mt-4 w-full max-w-[360px] grid grid-cols-3 gap-2">
                    <button aria-label={t("ui.savePoster")} onClick={p.saveConfig} className="py-2 px-3 text-[11px] font-bold btn-primary active:scale-[0.97] rounded-xl">{t("ui.savePoster")}</button>
                    ...
                    }} className="py-2 px-3 rounded-xl text-[11px] font-semibold bg-white/[0.06] border border-white/10 text-zinc-300 hover:bg-white/[0.10] hover:border-white/20 hover:text-white active:scale-[0.97] transition-all duration-200">{t("ui.testUrl")}</button>
                    {(() => {
