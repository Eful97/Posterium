      ...
      <div className="aspect-[2/3] relative overflow-hidden">
        ...
        {active && (
          <>
            ...
            <span className="absolute bottom-0 left-0 right-0 text-[8px] font-semibold text-orange-100 text-center py-0.5 bg-accent-orange/25 backdrop-blur-sm">{t("ui.selected")}</span>
          </>
        )}
