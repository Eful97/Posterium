...
export const MOCK_CTX: PosteriumCtx = {
  ...
  profileStateless: false,
  setProfileStateless: stubFn,
  profileConfigToken: null,
  setProfileConfigToken: stubFn,
  profileLocked: false,
  profileLoadError: "",
  profileLoading: false,
  unlockProfile: asyncStubFn,
  dismissProfileLock: stubFn,
  loadProfile: asyncStubFn,
  profileModalSuppressed: false,
  accentColor: null,
