...
export async function GET(req: NextRequest) {
  ...
  return Response.json({
    ...
    catalogs: [
      ...
      { id: "posterium-paramount-movies", name: "⛰️ Paramount+ — Film", type: "movie", extra: [{ name: "skip" }] },
      { id: "posterium-paramount-series", name: "⛰️ Paramount+ — Serie TV", type: "series", extra: [{ name: "skip" }] },
